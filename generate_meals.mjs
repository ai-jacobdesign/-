...
const baseMeals = [
  ...
  { category: 'bulgogi', name: '소고기 뭇국 건더기', main: '소고기 국거리 70g' },
  { category: 'bulgogi', name: '소고기 배추볶음', main: '소고기 배추볶음 80g' },
  { category: 'bulgogi', name: '소불고기 버섯볶음', main: '버섯 소불고기 80g' },
  { category: 'bulgogi', name: '너비아니 구이', main: '수제 너비아니 구이 80g' },
  { category: 'bulgogi', name: '육전', main: '소고기 육전 80g' },
  ...
  { category: 'pork', name: '수제 탕수육', main: '돼지 튀김 80g(소스찍먹)' },
  { category: 'pork', name: '돈육 가지볶음', main: '돈육 가지볶음 80g' },
  ...
  { category: 'chicken', name: '찜닭 건더기', main: '찜닭 건더기 80g(국물제외)' },
  { category: 'chicken', name: '닭고기 야채볶음', main: '닭고기 야채볶음 80g' },
  { category: 'chicken', name: '닭안심 장조림', main: '닭안심 장조림 70g' },
  { category: 'chicken', name: '수제 닭가슴살 소시지', main: '닭가슴살 소시지 80g' },
  { category: 'chicken', name: '치킨 스테이크', main: '치킨 스테이크 80g' },
  ...
  { category: 'fish', name: '연어 구이', main: '연어 소금구이 80g' },
  { category: 'fish', name: '대구 지리 건더기', main: '대구살 80g' },
  { category: 'fish', name: '굴비 구이', main: '굴비 구이 80g' },
  { category: 'fish', name: '동태찜', main: '동태찜 80g(국물제외)' },
  { category: 'fish', name: '고등어 구이', main: '고등어 소금구이 80g' },
  { category: 'fish', name: '임연수 구이', main: '임연수 구이 80g' },
  ...
  { category: 'tofu', name: '저염 마파두부', main: '저염 마파두부 100g' },
  { category: 'tofu', name: '두부 샐러드', main: '데친 두부 100g' },
  { category: 'tofu', name: '두부 계란말이', main: '두부 계란말이 100g' },
  { category: 'tofu', name: '수제 두부선', main: '수제 두부선 90g' },
  ...
  { category: 'vegetarian', name: '촉촉한 계란찜', main: '부드러운 계란찜 100g' },
];
...
const sideDishes1 = [
  ...
  '데친 고사리나물 40g', '데친 도라지 무침 40g', '데친 미나리 무침 40g', '마늘쫑 볶음 30g', '연근 조림 40g'
];
...
const sideDishes2 = [
  ...
  '맑은 배추국 100g', '맑은 쑥국 100g', '건새우 무국 100g', '팽이버섯 맑은국 100g', '맑은 순두부국 100g'
];
...
function generateMeals(count) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // Make variations of the mealName so they appear unique
    const indexSuffix = i >= baseMeals.length ? ` (V${Math.floor(i / baseMeals.length)})` : '';
    const uniqueMealName = base.name + indexSuffix;
    
    result.push({
      mealName: uniqueMealName,
